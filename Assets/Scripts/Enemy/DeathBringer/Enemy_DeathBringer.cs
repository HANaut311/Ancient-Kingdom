...
public class Enemy_DeathBringer : Enemy
{
    ...
    #region States
    public DeathBringerIdle idleState {get; private set;}
    // public SkeletonMoveState moveState {get; private set;}
    public DeathBringerTeleportState teleportState {get; private set;}
    public DeathBringerBattleState battleState {get; private set;}
    public DeathBringerAttack attackState {get; private set;}
    ...
    protected override void Awake()
    {
        ...
        idleState = new DeathBringerIdle(this, stateMachine, "Idle", this);
        teleportState = new DeathBringerTeleportState( this, stateMachine, "Teleport", this);
        battleState = new DeathBringerBattleState(this, stateMachine, "Move", this);
        attackState = new DeathBringerAttack(this,stateMachine, "Attack", this);
